...
class TestCheckPltEntries(unittest.TestCase):
    def _check_plt_entries(self, filename):
        ...
        if filename == os.path.join('armel', 'helloworld'):
            self.assertEqual(ld.main_object.plt, {'printf': 0x102e0, '__libc_start_main': 0x102ec,
        ...
        if filename == os.path.join('x86_64', 'true'):
            self.assertEqual(ld.main_object.plt, {'__uflow': 0x1440, 'getenv': 0x1448, 'free': 0x1450, 'abort': 0x1458, '__errno_location': 0x1460, 'strncmp': 0x1468, '_exit': 0x1470, '__fpending': 0x1478, 'textdomain': 0x1480, 'fclose': 0x1488, 'bindtextdomain': 0x1490, 'dcgettext': 0x1498, '__ctype_get_mb_cur_max': 0x14a0, 'strlen': 0x14a8, '__stack_chk_fail': 0x14b0, 'mbrtowc': 0x14b8, 'strrchr': 0x14c0, 'lseek': 0x14c8, 'memset': 0x14d0, 'fscanf': 0x14d8, 'close': 0x14e0, 'memcmp': 0x14e8, 'fputs_unlocked': 0x14f0, 'calloc': 0x14f8, 'strcmp': 0x1500, 'memcpy': 0x1508, 'fileno': 0x1510, 'malloc': 0x1518, 'fflush': 0x1520, 'nl_langinfo': 0x1528, 'ungetc': 0x1530, '__freading': 0x1538, 'realloc': 0x1540, 'fdopen': 0x1548, 'setlocale': 0x1550, '__printf_chk': 0x1558, 'error': 0x1560, 'open': 0x1568, 'fseeko': 0x1570, '__cxa_atexit': 0x1578, 'exit': 0x1580, 'fwrite': 0x1588, '__fprintf_chk': 0x1590, 'mbsinit': 0x1598, 'iswprint': 0x15a0, '__cxa_finalize': 0x15a8, '__ctype_b_loc': 0x15b0})
            return
