...
def test_first_fit():
    ...
    nose.tools.assert_less(ld.main_bin.mapped_base, ld.shared_objects['libc.so.6'].mapped_base)
    ...
    nose.tools.assert_less(ld.main_bin.mapped_base, ld.shared_objects['ld-linux-x86-64.so.2'].mapped_base)
    ...
    nose.tools.assert_less(ld.shared_objects['ld-linux-x86-64.so.2'].mapped_base, ld.main_bin.mapped_base)
    nose.tools.assert_less(ld.main_bin.mapped_base, ld.shared_objects['libc.so.6'].mapped_base)
